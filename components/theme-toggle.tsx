...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-7 h-7 flex items-center justify-center rounded-sm border border-border text-muted-foreground hover:text-foreground hover:border-border-soft transition-colors focus-visible:outline-2 focus-visible:outline-offset-2"
    >
...
// Inline SVGs — no icon library needed, consistent 16×16 iX-style strokes
function SunIcon() {
  return (
    <svg
